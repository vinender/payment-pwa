...
const CreditRentBoost = () => {
  return (
    <div className="relative flex flex-col items-center justify-center h-screen bg-theme p-4">
      ...
      <button className="absolute bottom-10 text-white font-bold py-2 px-4 rounded-full mt-8">
        Close
      </button>
    </div>
  );
