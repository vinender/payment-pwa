  ...
  return (
    <div className="  bg-gray-900 flex justify-center items-center h-screen">
      <div className="bg-[#1B9C83] w-full  h-screen overflow-y-auto text-white relative z-20">
        ...
        <div className=" bg-emerald-100 text-gray-800 mx-auto rounded-t-[2rem]  absolute  bottom-0 left-0 right-0 h-[calc(100%-110px)] overflow-y-hidden">
          <div className="bg-white  h-full p-6    shadow-lg">
            <div className="flex items-center mb-6">
                <img alt='flash' src='./demo/flash.png' className='relative -top-2 hidden bg-white opacity-90 left-5 z-50 ' />
                ...
                <div className='  border-[3.91px]  border-[#1B9C83] rounded-xl'>
                    <div className='rounded-xl  bg-emerald-100 p'> 
                        <button className="bg-emerald-200 border text-black border-[#1B9C83]  relative top-5 left-5 px-3 py-1 tracking-widest rounded-full border-b-4 text-sm font-bold mb-6">
                        SUBSCRIBE
                        </button>
                    ...
                    <div className="space-y-3 mt-6 p-2 bg-white rounded-xl">
                        <button className="w-full bg-gradient-to-r from-[#1B9C83] to-emerald-400 text-white p-4 rounded-xl text-left flex justify-between items-center">
                            <div>
                            <div className="font-poppins font-semibold text-md sm:text-lg">$12 / month</div>
                        ...
                        <button className="w-full bg-gradient-to-r from-[#1B9C83] to-emerald-400 text-white p-4 rounded-xl text-left flex justify-between items-center">
                            <div>
                            <div className="font-poppins font-semibold text-md sm:text-lg">$120 / year</div>
